...
public class ChangeNameDialogFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.pop_my_change_name_view,container,false);
        getDialog().requestWindowFeature(Window.FEATURE_NO_TITLE);//去掉对话框的标题
        activity = (MyActivity) getActivity();
        editContent = view.findViewById(R.id.edit_name);
    ...
    public void onResume() {
        ...
        ok.setOnClickListener(v -> {
            ...
            activity.changeUserName(Users.userId,newName).observe(this,baseResult -> {
